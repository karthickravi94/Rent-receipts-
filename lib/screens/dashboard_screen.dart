...
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final monthReceipts = receiptProvider.filtered(
        month: currentMonth, year: now.year);
    final totalRent = tenants.fold<double>(
        0, (sum, t) => sum + t.monthlyRent);
    final collectedThisMonth = monthReceipts.fold<double>(
